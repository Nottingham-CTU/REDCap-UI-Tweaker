...
class TestT38Showhiddenfieldsondev():
  ...
  def test_t38Showhiddenfieldsondev(self):
    ...
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.CSS_SELECTOR, "[name=\"show-hidden-fields\"]")))
    self.driver.execute_script("sessionStorage.setItem(\'test-savedsetting\',$(\'[name=\"show-hidden-fields\"]\').prop(\'checked\'))")
    element = self.driver.find_element(By.CSS_SELECTOR, "[name=\"show-hidden-fields\"]")
    ...
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.ID, "footer")))
    elements = self.driver.find_elements(By.ID, "show-hidden-btn")
    assert len(elements) == 0
    ...
    for i in range(0, 2):
      ...
      self.driver.execute_script("$(\'#footer\').remove();window.location.href=sessionStorage.getItem(\'test-surveylink\')")
      WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.ID, "footer")))
      WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.ID, "show-hidden-btn")))
      elements = self.driver.find_elements(By.ID, "show-hidden-btn")
      assert len(elements) > 0
      self.driver.execute_script("window.history.back()")
      WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.ID, "rc-login-form")))
    ...
    self.driver.find_element(By.CSS_SELECTOR, "tr[data-module=\"redcap_ui_tweaker\"] button.external-modules-configure-button").click()
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.CSS_SELECTOR, "[name=\"show-hidden-fields\"]")))
    self.driver.execute_script("$(\'[name=\"show-hidden-fields\"]\').prop(\'checked\',sessionStorage.getItem(\'test-savedsetting\')==\'true\')")
    self.driver.find_element(By.CSS_SELECTOR, "#external-modules-configure-modal .modal-footer .save").click()
    time.sleep(2)
