...
class TestT21Defaultreasonforchange():
  ...
  def test_t21Defaultreasonforchange(self):
    self.driver.get("http://127.0.0.1/")
    self.driver.find_element(By.LINK_TEXT, "My Projects").click()
    elements = self.driver.find_elements(By.XPATH, "//*[@id=\"table-proj_table\"][contains(.,\'REDCap UI Tweaker Test\')]")
    assert len(elements) > 0
    elements = self.driver.find_elements(By.XPATH, "//*[@id=\"table-proj_table\"][contains(.,\'REDCap UI Tweaker RFC Test\')]")
    assert len(elements) == 0
    ...
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.CSS_SELECTOR, "[name=\"require-change-reason\"]")))
    self.driver.execute_script("sessionStorage.setItem(\'test-savedsetting\',$(\'[name=\"require-change-reason\"]:checked\').val())")
    element = self.driver.find_element(By.CSS_SELECTOR, "[name=\"require-change-reason\"][value=\"2\"]")
    ...
    self.driver.find_element(By.ID, "app_title").send_keys("REDCap UI Tweaker RFC Test")
    ...
    time.sleep(2)
    self.driver.find_element(By.LINK_TEXT, "My Projects").click()
    self.driver.find_element(By.LINK_TEXT, "REDCap UI Tweaker RFC Test").click()
    assert self.driver.find_element(By.ID, "require_change_reason").is_selected() is True
    ...
    assert self.driver.find_element(By.NAME, "require-change-reason-complete").is_selected() is True
    ...
    self.driver.find_element(By.CSS_SELECTOR, "tr[data-module=\"redcap_ui_tweaker\"] button.external-modules-configure-button").click()
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.CSS_SELECTOR, "[name=\"require-change-reason\"]")))
    self.driver.execute_script("$(\'[name=\"require-change-reason\"][value=\"\'+sessionStorage.getItem(\'test-savedsetting\')+\'\"]\').prop(\'checked\',true)")
    self.driver.find_element(By.CSS_SELECTOR, "#external-modules-configure-modal .modal-footer .save").click()
    time.sleep(2)
